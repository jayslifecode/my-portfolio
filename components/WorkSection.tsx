...
const projects: Project[] = [
  {
    name: 'One Day Mongolia',
    desc: 'Ecommerce platform — Shopify + Next.js + Stripe. Built from scratch, ships nationwide.',
  ...
  {
    name: 'Digital Mind',
    desc: 'Agency site — React, GSAP animations, Vercel. Yes, I built the site for my own company.',
    tags: ['React', 'GSAP', 'Vercel', 'Sanity'],
    url: 'https://digitalmind.mn',
    year: '2024',
    color: '#0a0012',
  },
  {
    name: 'AI Automation Suite',
    desc: 'Custom workflow automation stack — OpenAI + n8n + Python. Now running in production so I can sleep.',
    tags: ['OpenAI', 'n8n', 'Python', 'Next.js'],
    year: '2023',
    color: '#000a0a',
  },
]
